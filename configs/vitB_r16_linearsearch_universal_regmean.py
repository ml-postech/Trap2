...
config = {
    ...
    'model': {
        ...
        'bases': [
            ...
            os.path.join(ADAPTER_ROOT, "b32_lora_gtsrb"),
    ...
    'task_merge_config': {
        ...
        'grams_data_distribution': "class-wise", #"random",
        'grams_data_measure': "quantity",
        'grams_data_quantity': 100,
